 ...
 */
function dynamic_example_form_install_configure_form_alter(&$form, $form_state) {
 ...
 */
function dynamic_example_install_tasks() {
  $tasks = array();

  $tasks['dynamic_example_setup_variables'] = array(
    'display_name' => st('Set Variables'),
    'display' => FALSE,
  );

  $tasks['dynamic_example_setup_og_permissions'] = array(
    'display_name' => st('Set Blocks'),
    'display' => FALSE,
  );

  // Run this as the last task!
  $tasks['dynamic_example_setup_rebuild_permissions'] = array(
 ...
 */
function dynamic_example_setup_variables() {
  $variables = array(
    // Features default export path.
    'features_default_export_path' => 'profiles/dynamic_example/modules/custom',
    // Mime-mail.
    'mimemail_format' => 'full_html',
    'mimemail_sitestyle' => FALSE,
    'mimemail_name' => 'DynamicExample',
    'mimemail_mail' => 'info@dynamic_example.com',
    // jQuery versions.
 ...
 * created.
 */
function dynamic_example_setup_og_permissions() {
 ...
 */
function dynamic_example_setup_blocks() {
 ...
 * installation.
 */
function dynamic_example_setup_rebuild_permissions() {
  node_access_rebuild();
}
